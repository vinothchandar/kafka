...
public class StreamsConfig extends AbstractConfig {
    ...
    /**{@code allow.stale.state.reads.} */
    @SuppressWarnings("WeakerAccess")
    public static final String ALLOW_STALE_STATE_STORE_READS_CONFIG = "allow.stale.state.reads";
    private static final String ALLOW_STALE_STATE_STORE_READS_DOC = "When 'true' (default), interactive queries can access state stores, even when there is a rebalancing/state restoration in progress";
    ...
    static {
        CONFIG = new ConfigDef()
            ...
            // LOW
            .define(ALLOW_STALE_STATE_STORE_READS_CONFIG,
                Type.BOOLEAN,
                true,
                Importance.LOW,
                ALLOW_STALE_STATE_STORE_READS_DOC)
