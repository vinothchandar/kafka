...
public class AssignmentInfoTest {
    ...
    public void shouldUseLatestSupportedVersionByDefault() {
        final AssignmentInfo info = new AssignmentInfo(activeTasks, standbyTasks, globalAssignment, Collections.emptyMap());
    ...
    public void shouldEncodeAndDecodeVersion1() {
        ...
        final AssignmentInfo expectedInfo = new AssignmentInfo(1, UNKNOWN, activeTasks, standbyTasks, Collections.<HostInfo, Set<TopicPartition>>emptyMap(), Collections.emptyMap(), 0);
